...
const superadminroutes = [
    ...
    { path: '/superadmin/borrowerlander', exact: true, name: 'CustomerApproved', component: LenderBorrowerDetail },
    { path: '/superadmin/borrowerlanderAdminApproved', exact: true, name: 'AdminApproved', component: LenderBorroweDetailAdminApproved},
    { path: '/superadmin/borrowerlanderCompleteApproved', exact: true, name: 'CompleteApproved', component: LenderBorroweDetailCompleteApproved},
