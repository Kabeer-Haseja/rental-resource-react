...
const TABLE_HEAD = [
 ...
 const dispatch=useDispatch()
  ...
  const data=JSON.parse(localStorage.getItem('ssd'));
       axios.get(`http://localhost:8080/get/product/${data.id}`).then((response)=>{
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      const { id, name,description, price, category,productImages } = row;
                        ...
                        >
                          <TableCell component="th" scope="row" padding="none">
                            <Stack direction="row" alignItems="center" spacing={2}>
                              <Avatar alt={name} src={productImages[0].url} />
